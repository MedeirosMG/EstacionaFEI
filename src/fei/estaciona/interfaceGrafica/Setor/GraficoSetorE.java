...
import fei.estaciona.setor.SetorE;
...
public class GraficoSetorE extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private SetorE setor = new SetorE();
	...
	public GraficoSetorE() {
		...
		JLabel lblSetorA = new JLabel("Setor E");
