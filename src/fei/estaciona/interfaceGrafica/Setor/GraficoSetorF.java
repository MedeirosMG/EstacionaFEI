...
public class GraficoSetorF extends JPanel {
	...
	public GraficoSetorF() {
		...
		botaoPreencher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				for(int i = 0 ; i <16 ; i++)
				{
					...
					if(tipos[i].isSelected() && setor.verifica_disponibilidade_vaga(i+1))
					{
						paineis[i].setBackground(Color.red);
						setor.alterar_Disponibilidade_Vaga(false, i+1);
						tipos[i].setSelected(false);
					}
					else if(tipos[i].isSelected() && !setor.verifica_disponibilidade_vaga(i+1))
					{
						paineis[i].setBackground(Color.green);
						setor.alterar_Disponibilidade_Vaga(true, i+1);
						tipos[i].setSelected(false);
					}
		...
		btnRemoverVagas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				for(int i = 0 ; i < 16 ; i++)
				{
					if(!setor.verifica_disponibilidade_vaga(i+1))
					{
